 ...
 */
class sprietnbox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "sprietn@sprietn";
    public $boxlabel;
    public $depends = array("sprietn");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/sprietn/class/sprietn.class.php";
